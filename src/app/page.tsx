  ...
  return (
    <main className="min-h-screen bg-[url('/bg-home.webp')] flex items-center justify-center p-4">
      ...
      <div className="text-center text-white max-w-2xl space-y-6">
        <h1 className="text-lg md:text-4xl font-bold flex text-amber-500 gap-1"><img src='/Asset 20.png' className="w-10 h-10 items-baseline"/> Quốc Lâm Tự - Xem Phim Sex Online Chất Lượng Cao</h1>
       <HeroTitle/>
...
<h2 className="text-lg text-gray-300">
          Link web xem phim full HD hiện tại là:<p className="text-amber-300 hover:text-amber-400"><a href="https://quoclamtu.live" target="_blank" rel="noopener noreferrer">quoclamtu.live</a></p> Quý khách hàng lưu lại thông tin tại:
          <p className="text-amber-300 hover:text-amber-400"><a href="/">quoclamtu.tv</a></p> khi có thay đổi đường link sẽ thông báo ở web <span className="text-amber-300 hover:text-amber-400">quoclamtu.tv (đường link không bao giờ chị chặn của quốc lâm tự)</span>
        </h2>
        ...
        <div className="pt-6 border-t border-gray-600">
          <h2 className="text-xl font-semibold my-4">📌 Tính năng nổi bật</h2>
